...
var BEEZ_TOUCH_VERSION="0.2.3";"undefined"!=typeof module&&module.exports?exports.VERSION=BEEZ_TOUCH_VERSION:!function(){define("beez.touch",["require","exports","module","beez"],function(t){var e=t("beez"),h=e.getLogger("beez.touch");if(e.touch)return h.warn("beez.touch is already loaded."),e.touch;var a=e.vendor._,s=e.vendor.$,c="ontouchstart"in window,i=function(t){return c?t.originalEvent?t.originalEvent.touches[0]||t.originalEvent.changedTouches[0]:t.changedTouches[0]:t},n=e.View.extend("beez.Touch",{initialize:function(t){n.__super__.initialize.apply(this,arguments),t=t||{},t.bztch=t.bztch||{},this._bztchTaps=null,this._bztchIsTappable=!1,this._bztchIsDisable=!1,this._bztchIsTapMouseDown=!1,this._bztchPrefix=a.isString(t.bztch.prefix)?t.bztch.prefix:"bztch",this._bztchTapPrefix=this._bztchPrefix+"-tap",this._bztchHoverClassName=a.isString(t.bztch.hoverClassName)?t.bztch.hoverClassName:"hover",this._bztchPreventDefault=t.bztch.preventDefault||!1,this._bztchStartPosition={},this._bztchThreshold=t.bztch.threshold||10},tap:function(t,e,h,s){var i,n,o,l,b,p,z;if(a.isArray(t)&&t.length>1)return void a.each(t,function(a,c){this.tap(t.eq(c),e,h,s)},this);if(!this._bztchTaps){i={},c?(i["touchstart ."+this._bztchTapPrefix]="onBztchTapStart",i["touchmove ."+this._bztchTapPrefix]="onBztchTapMove",i["touchend ."+this._bztchTapPrefix]="onBztchTapEnd",i["touchcancel ."+this._bztchTapPrefix]="onBztchTapCancel"):(i["mousedown ."+this._bztchTapPrefix]="onBztchTapMouseDown",i["mousemove ."+this._bztchTapPrefix]="onBztchTapMouseMove",i["mouseup ."+this._bztchTapPrefix]="onBztchTapMouseUp",i["mouseleave ."+this._bztchTapPrefix]="onBztchMouseLeave");for(n in i)o=this[i[n]],l=n.match(/^(\S+)\s*(.*)$/),b=l[1],p=l[2],o=a.bind(o,this),b+=".delegateEvents"+this.cid,t===this.$el?this.$el.on(b,o):this.$el.on(b,p,o);this._bztchTaps={}}z=a.uniqueId(this._bztchTapPrefix+"-"),this._bztchTaps[z]={callback:e,callbackStart:s?a.isFunction(s.tapStart)?s.tapStart:null:null,callbackMove:s?a.isFunction(s.tapMove)?s.tapMove:null:null,callbackEnd:s?a.isFunction(s.tapEnd)?s.tapEnd:null:null,callbackCancel:s?a.isFunction(s.tapCancel)?s.tapCancel:null:null,context:h},t.addClass(this._bztchTapPrefix),t.attr("data-"+this._bztchTapPrefix+"Uid",z)},onBztchTapStart:function(t){var e,h=s(t.currentTarget);t=i(t),e=this.bztchGetId(h),e&&this.bztchHasTap(e)&&(this._bztchPreventDefault&&t.preventDefault(),this._bztchStartPosition={x:t.pageX,y:t.pageY},h.hasClass(this._bztchDisableClassName)||(this._bztchIsTappable=!0,this._bztchTaps[e].callbackStart&&this._bztchTaps[e].callbackStart.call(this._bztchTaps[e].context,t),h.addClass(this._bztchHoverClassName)))},onBztchTapMove:function(t){var e,h=s(t.currentTarget);t=i(t),e=this.bztchGetId(h),e&&this.bztchHasTap(e)&&(this._bztchPreventDefault&&t.preventDefault(),this._bztchTaps[e].callbackMove&&this._bztchTaps[e].callbackMove.call(this._bztchTaps[e].context,t),(Math.abs(t.pageX-this._bztchStartPosition.x)>this._bztchThreshold||Math.abs(t.pageY-this._bztchStartPosition.y)>this._bztchThreshold)&&(this._bztchIsTappable=!1,h.removeClass(this._bztchHoverClassName)))},onBztchTapEnd:function(t){var e,h=s(t.currentTarget);if(t=i(t),e=this.bztchGetId(h),e&&this.bztchHasTap(e)){if(this._bztchPreventDefault&&t.preventDefault(),this._bztchIsTappable&&!h.hasClass(this._bztchDisableClassName)){if(this._bztchTaps[e].callback&&this._bztchTaps[e].callback.call(this._bztchTaps[e].context,t),!this._bztchTaps)return;this._bztchTaps[e].callbackEnd&&this._bztchTaps[e].callbackEnd.call(this._bztchTaps[e].context,t)}this._bztchIsTappable=!1,h.removeClass(this._bztchHoverClassName)}},onBztchTapCancel:function(t){var e,h=s(t.currentTarget);t=i(t),e=this.bztchGetId(h),e&&this.bztchHasTap(e)&&(this._bztchTaps[e].callbackCancel&&this._bztchTaps[e].callbackCancel.call(this._bztchTaps[e].context,t),this._bztchIsTappable=!1,h.removeClass(this._bztchHoverClassName))},onBztchTapMouseDown:function(t){this._bztchIsTapMouseDown=!0,t.touches=[{}],t.touches[0].clientX=arguments[0].clientX,t.touches[0].clientY=arguments[0].clientY,this.onBztchTapStart.apply(this,arguments)},onBztchTapMouseMove:function(t){this._bztchIsTapMouseDown&&(t.touches=[{}],t.touches[0].clientX=t.clientX,t.touches[0].clientY=t.clientY,this.onBztchTapMove.apply(this,arguments))},onBztchTapMouseUp:function(t){this._bztchIsTapMouseDown=!1,t.touches=[{}],t.touches[0].clientX=t.clientX,t.touches[0].clientY=t.clientY,this.onBztchTapEnd.apply(this,arguments)},onBztchMouseLeave:function(){this._bztchIsTapMouseDown=!1,this.onBztchTapCancel.apply(this,arguments)},bztchGetId:function(t){return t.attr("data-"+this._bztchTapPrefix+"Uid")},bztchHasTap:function(t){return a.has(this._bztchTaps?this._bztchTaps:{},t)},dispose:function(){a.each(this._bztchTaps,function(t,e){delete this._bztchTaps[e].callback,delete this._bztchTaps[e].callbackStart,delete this._bztchTaps[e].callbackMove,delete this._bztchTaps[e].context,delete this._bztchTaps[e]},this),delete this._bztchTaps,delete this._bztchIsTappable,delete this._bztchIsTapMouseDown,delete this._bztchPrefix,delete this._bztchTapPrefix,delete this._bztchHoverClassName,delete this._bztchStartPosition,n.__super__.dispose.apply(this,arguments)}});return e.touch={View:n},e.touch})}(this);